const ipcEN =
    '''Content in Klikjob is based on User Generated Content (UGC). At the time of freelancer registration and submission of PAW creation, Klikjob examines the content created/uploaded by the User for copyright infringement or other rights. However, due to our limits, Klikjob cannot guarantee that any content submitted and passed inspection is 100% free of these infractions. However, if you suspect that content has been created/uploaded that breaches your copyright or related exclusive rights, please follow the process as follows.
...
The Klikjob Help Center team will investigate reported infractions and remove or disable content that is proven to breach third-party rights.

KLIKJOB ALWAYS OBEYS AND SUBMITS TO THE LOCAL LAW THAT REGULATES WHEREVER OUR USERS ARE. KLIKJOB IS NOT LIABLE FOR ANY INFRINGEMENTS OF COPYRIGHT OR ASSOCIATED EXCLUSIVE RIGHTS THAT OUR USERS COMMIT OR PERPETUATE. IF AN INFRINGEMENT IS IDENTIFIED AND YOU OPT TO FILE A LAWSUIT AGAINST THE OTHER USER IMPLICATED, YOU UNDERSTAND AND AGREE THAT KLIKJOB WILL NOT BE INVOLVED IN THE LAWSUIT PROCESS. YOU ALSO RECOGNIZE AND AGREE THAT YOU WILL RELEASE ALL LITIGATION AGAINST KLIKJOB, WHERE ALL SORTS OF CHARGES OR FINANCES NEEDED/INCURRED TO BRING THIS INFRINGEMENT TO COURT WILL BE FULLY BORNE BY YOURSELF.
''';
const cookiesEN =
    '''The purpose and application of cookies on the Klikjob.com website are described in this Cookie Policy. Please read this Cookie Policy so that you are aware of our cookie collection, usage, and disclosure policies as well as your options when it comes to using cookies.
...
Apart from legally prohibited services, Klikjob strongly advises all Users not to offer, request, or purchase certain services that are misleading and have a negative impact on certain people, institutions, or products in the context of political competition, commercial business, or hatred of certain groups.
It is prohibited for each User to offer, request, and purchase:
...
Services for negative political campaigning. Klikjob really appreciates political moments while still believing that every individual has the right to express their political choices. Klikjob, on the other hand, is vehemently opposed to any form of negative political expression aimed at rejecting, vilifying, or even insulting other individuals within the scope of political competition.
...
Klikjob fervently opposes all kinds of offers or requests made by Freelancers or Buyers that have the potential to result in academic violations or to hurt or break the code of ethics of specific professional associations that are legally protected.
It is prohibited for each User to offer, request, and purchase:
...
We strongly recommend Freelancers not to make excessive promises when selling/offering their services, either through PAW, pitching, or during the Offer process. You don't know what unforeseen constraints can disrupt you, and it is feared that this action will backfire on you (e.g., Users who are your customers file a dispute on your project because they feel you are not delivering the appropriate work). Klikjob is not liable for the losses you suffer if your project is disputed and the Buyer wins the dispute.

User Generated Content (UGC)

Klikjob is also a platform for the User community (both Freelancers and Buyers) to contribute content. Klikjob believes and guarantees that all Users are free to utilize our platform to create interesting material as part of their freedom of expression and to voice their thoughts. Nevertheless, some content creation restrictions are deemed relevant enough to serve as guidelines.
...
Klikjob does not have full control over how each User acts, behaves, and interacts with other Users. This limitation must therefore be highlighted, as these Community Guidelines also have supervisory constraints, but strive to continue to urge all users to avoid behaviour that has a proclivity for all types of violence and criminality.
Each Klikjob User is prohibited from:
...
Inciting other Users, whether or not they use the Klikjob site, to act illegally;
...
Klikjob will severely enforce these Community Guidelines against any User who violates them. Klikjob has the right to suspend or permanently terminate the infringer's account. Every User is expected to report any violations that occur using the reporting tools provided. Our Customer Support Service staff likewise needs sufficient proof to respond decisively. Klikjob will not process the action if there is insufficient (corroborating) evidence. Klikjob will always cooperate with authorities to take appropriate preventative and legal measures.
''';
