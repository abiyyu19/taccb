...
&nbsp;&nbsp;&nbsp;&nbsp; **COLLARBEAR** is a platform for connecting Service Users (hereinafter referred to as Buyer) and Service Providers (hereinafter referred to as Freelancer) to conduct sales and purchases of services created by PT. Bionic Teknologi Indonesia (hereinafter referred to as BTI). It is accessible through the website [www.COLLARBEAR.com](http://www.collarbear.com) as well as a mobile application based on Android (available and downloadable on Google Play) and iOS (available and downloadable on App Store).

&nbsp;&nbsp;&nbsp;&nbsp; **ALL USERS OF COLLARBEAR (HEREINAFTER REFERRED TO AS USER) SHALL BE BOUND BY THE TERMS OF SERVICE, TERMS OF PAYMENT, PRIVACY POLICY, AND COOKIE POLICY, AS WELL AS OTHER AGREEMENTS PUBLICLY PUBLISHED BY COLLARBEAR.**

&nbsp;&nbsp;&nbsp;&nbsp; **YOU ARE WELCOME TO READ THIS AGREEMENT CAREFULLY BEFORE PROCEEDING TO USE THE SITE AND/OR THE COLLARBEAR MOBILE APPLICATION. BY CHECKING THE BOX "I HAVE READ AND AGREE TO THE TERMS OF SERVICE" AND PRESSING THE "ACCEPT" BUTTON THAT APPEARS ON YOUR INTERFACE, THEN YOU HAVE AGREED – ON YOUR BEHALF AND YOUR CONDITION – CONSCIOUSLY AND WITHOUT COERCION TO ACCEPT AND AGREE TO ABIDE BY THIS AGREEMENT.**

&nbsp;&nbsp;&nbsp;&nbsp; **IF YOU DO NOT AGREE TO ANY OF THE TERMS OF THIS AGREEMENT, PLEASE QUIT THE COLLARBEAR WEBSITE AND/OR REMOVE OUR MOBILE APP IMMEDIATELY FROM YOUR GADGET.**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR provides services and may be accessed by any User who has reached the age of 17 (seventeen) years old and/or has been recognized legally competent to enter into a Cooperation Contract. If you are under 17 (seventeen) years old or at least 13 (thirteen) years old, you may only use COLLARBEAR through ownership of a parent or legal guardian's account. You are not permitted to use COLLARBEAR if you are younger than 13 (thirteen) years old.

&nbsp;&nbsp;&nbsp;&nbsp; We offer a Customer Support Service that is available 24/7. Our team can assist you if you have any queries about COLLARBEAR or this Agreement.

&nbsp;&nbsp;&nbsp;&nbsp; This Agreement and all other documents included in or obtained from COLLARBEAR were originally written in Indonesian. Only for your reading and understanding convenience has COLLARBEAR produced translated versions. The Indonesian language version shall take precedence over translations into any other languages in the event of a discrepancy.
...
&nbsp;&nbsp;&nbsp;&nbsp; Service Users or parties who register on the COLLARBEAR platform, look for services, launch service project auctions, and make purchases of services provided/offered by Service Providers.
...
&nbsp;&nbsp;&nbsp;&nbsp; Service Providers or parties who use the COLLARBEAR platform to create accounts for, look for service project auctions those Service Users have launched, and complete service sales transactions that Service Users want/need.
...
&nbsp;&nbsp;&nbsp;&nbsp; The conversation/negotiation that takes place in the chat room or project auction provided by COLLARBEAR between the Buyer and the Freelancer with the aim or objective of coming to an agreement (in carrying out) a service sale-purchase transaction.

### **Professional Ability Widget (PAW)**

&nbsp;&nbsp;&nbsp;&nbsp; Services that Freelancers offer and sell on the marketplace belong to COLLARBEAR.

### **Project Auction**

&nbsp;&nbsp;&nbsp;&nbsp; The process of auctioning a service project opened/launched by a Buyer and displayed on COLLARBEAR's marketplace so that Freelancers can bid.
...
&nbsp;&nbsp;&nbsp;&nbsp; Also known as Viewer and Visitor—COLLARBEAR users or all parties who have not registered or have registered and have an account with COLLARBEAR; both those who use COLLARBEAR's services through the website or mobile application as well as casual visitors who just stop by and take a peek.

# **Service Information**

&nbsp;&nbsp;&nbsp;&nbsp; Only registered Users may purchase and/or sell services in COLLARBEAR. By registering to create an account, you agree to provide us with accurate, up-to-date, and comprehensive information, and not knowingly register for distorted purposes. You are solely responsible for all actions you do while using COLLARBEAR, including safeguarding the privacy and security of your personal information, account password, and any other sensitive data. We are not responsible for any negligence that you make with your own account.

&nbsp;&nbsp;&nbsp;&nbsp; Within COLLARBEAR, Buyer can search, view Freelancer profiles, make contact with Freelancer via instant messaging media that has been provided within COLLARBEAR, and place orders for services owned or offered by Freelancer through COLLARBEAR.
...
&nbsp;&nbsp;&nbsp;&nbsp; To ensure User safety and convenience, when a Buyer places an order, the Buyer must make an advance payment to COLLARBEAR (see COLLARBEAR's Terms of Payment). If the Buyer has accepted the Freelancer's work, COLLARBEAR will send the payment from the Buyer to the Freelancer. When ordering services from Field Workers, the outcome of the work is established based on a defined and agreed-upon time, and payment is then sent straight to the relevant Freelancer.
...
&nbsp;&nbsp;&nbsp;&nbsp; Except as otherwise agreed to by the Buyer and the Freelancer in the joint agreement, the Buyer has the right to ownership of the work delivered by the Freelancer when the Buyer makes a purchase. Future disputes over who owns the rights to the work, claims/ accusations of plagiarism, and/or contraventions of other government regulations/legal requirements that lead to legal action against Buyers or Freelancers are not COLLARBEAR's responsibility.

&nbsp;&nbsp;&nbsp;&nbsp; All works submitted, published, or uploaded by Freelancer may be used without restriction by COLLARBEAR for marketing and promotional strategies.

&nbsp;&nbsp;&nbsp;&nbsp; Users are not permitted to use any other payment methods than those provided by COLLARBEAR. Any orders or payments made outside of the platform or through methods other than those offered by COLLARBEAR are not the responsibility of COLLARBEAR.

&nbsp;&nbsp;&nbsp;&nbsp; The Community Guidelines, which serve as the ground rules for the community and online trading on the COLLARBEAR platform, must be followed by every User. These Terms of Service are inextricably linked with the Community Guidelines.

&nbsp;&nbsp;&nbsp;&nbsp; Any account that violates the Terms of Service and/or Community Guidelines, or as a result of illegal activity or other actions that are not in accordance with the Terms of Service for use of services on the COLLARBEAR platform, may have its account disabled temporarily (Suspended) or permanently by COLLARBEAR. Users who have had their accounts temporarily suspended can get in touch with our Customer Support Service to ask concerns, gain clarification on violations, or learn the requirements for getting or reactivating their accounts.

&nbsp;&nbsp;&nbsp;&nbsp; Each User must maintain the confidentiality of sensitive data and account passwords for the security of their account. In the event of an account breach and the original owner of the account seeks to freeze and restore their account, users must be able to verify ownership of their account at COLLARBEAR’s Customer Support Service by providing materials or evidence that can prove authentication of account ownership.

&nbsp;&nbsp;&nbsp;&nbsp; These Terms of Service are subject to change at any time by COLLARBEAR with or without prior notice to any User. COLLARBEAR interprets your action as an endorsement of these changes if you continue to use our platform after the Terms & Conditions of Service have been changed.

# **Buyer**

### **General**

&nbsp;&nbsp;&nbsp;&nbsp; Buyer are not permitted to offer payment options other than those given by COLLARBEAR.Buyers can only make purchases after getting an offer card from Freelancer.For the sake of mutual security and convenience, each User is prohibited from providing telephone numbers and other specific personal data to other Users. COLLARBEAR disclaims all liability for the improper use of any data and information shared by a User with other Users.

### **Purchase**

&nbsp;&nbsp;&nbsp;&nbsp; Users are expected to read carefully the Terms of Payment in order to purchase and pay for services on the COLLARBEAR platform.
...
&nbsp;&nbsp;&nbsp;&nbsp; Buyer can request (or receive) "Notes" or briefing notes, which are summaries of discussions that took place using the COLLARBEAR instant messaging media. Briefing notes that Freelancer send can be accepted or rejected by Buyers. The briefing note form won't provide an option button if the briefing note is simply text-based. The Buyer may opt to accept or reject a change made by the Freelancer to the "Progress Line" or the percentage of work processes and/or a special offer made in the briefing note form. The briefing note will affect the payment plan in case of cancellation. Each User is urged to read and comprehend COLLARBEAR's Terms of Payment in order to fully understand the requirements.
...
&nbsp;&nbsp;&nbsp;&nbsp; Successfully placed orders mean that the Freelancer needs to get to work on his offerings. When the User signs in, the COLLARBEAR system will send notifications via email as well as notifications on the platform.
...
&nbsp;&nbsp;&nbsp;&nbsp; In addition to these justifications, to cancel an order, the Buyer must report the related order to our Committee through COLLARBEAR’s Customer Support Service.

### **Project Auction**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR provides a feature in the form of an auction system where Buyers can post requests for certain services with the aim of getting bids from Freelancers. Buyers can select the bid they believe is the best bid for them and begin the Offer with the Freelancer who wins the auction.

&nbsp;&nbsp;&nbsp;&nbsp; If the Buyer requires a service whose category is not/not yet available at COLLARBEAR, then the Buyer can open a service project auction by selecting the closest category.
...
If a violation of one or all of these points is found, the system will suspend the offender's account for an indefinite duration/time. COLLARBEAR is not liable for any losses incurred by the User as a result of the account suspension.

### **Project Guarantee**

&nbsp;&nbsp;&nbsp;&nbsp; A project guarantee offered by COLLARBEAR is an option in the Project Auction. This option is subject to the Buyer's payment of a deposit equal to the budget's estimated outlay for the project that will be tendered.
...
&nbsp;&nbsp;&nbsp;&nbsp; We require Buyers to provide reviews & ratings after each successful order in order to preserve the credibility and caliber of our marketplace. Reviews & ratings are founded on transparency, honesty and are not dependent on any external pressure, ensuring the integrity of Freelancers inside the COLLARBEAR ecosystem. Reviews & ratings cannot be given by Buyers if an order is cancelled/disputed.

# **Freelancer**

### **General**

&nbsp;&nbsp;&nbsp;&nbsp; At COLLARBEAR, we never stop trying to keep everyone in our community safe. As a result, we strongly require Freelancers to authenticate their identities with official (directly issued) government identity credentials (i.e. ID card, passport).

&nbsp;&nbsp;&nbsp;&nbsp; In some situations (if you offer certain categories of services), completion of this process is necessary in order to be able to advertise your services on COLLARBEAR. Completion of this process can also earn you a "Verified" badge on your Freelancer profile.

### **Freelancer Type**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR classifies Freelancers into two types, namely Inside Workers and Field Workers.
...
&nbsp;&nbsp;&nbsp;&nbsp; Future market needs and expectations, as well as feedback from our community, will be one of the two elements influencing COLLARBEAR's choice of whether to add new Inside Worker classifications.
...
&nbsp;&nbsp;&nbsp;&nbsp; Future market needs and expectations, as well as feedback from our community, will be one of the two elements influencing COLLARBEAR's choice of whether to add new FIeld Worker classifications.
...
&nbsp;&nbsp;&nbsp;&nbsp; Professional Ability Widget (PAW) refers to the services that you advertise and offer at COLLARBEAR. With PAW, Freelancers showcase their skills, expertise, qualifications, and portfolio to the world by displaying them at COLLARBEAR like a shop window in a shopping centre where potential buyers can be lured into buying while looking around while walking and wandering aimlessly.
...
&nbsp;&nbsp;&nbsp;&nbsp; In order to maintain service quality and create an ecosystem with fair business competition in the COLLARBEAR market, we set a minimum service price that can be offered by Freelancers (both Inside Workers and Field Workers) of IDR 150,000.

### **Auto Acceptance Lead Time (AALT)**

&nbsp;&nbsp;&nbsp;&nbsp; The price that Freelancers set for the services they provide/offer in each package in PAW is used by COLLARBEAR to grade each package's AALT.

### **On Stage**

&nbsp;&nbsp;&nbsp;&nbsp; By utilizing a bid system, COLLARBEAR offers Freelancers the opportunity to advertise their PAW on websites and mobile applications for a fee (or receive it for free) in accordance with applicable terms.
...
&nbsp;&nbsp;&nbsp;&nbsp; To fill/top-up the PAW Stage Balance, you can only go through COLLARBEAR Balance (or also known as CB Balance). PAW Stage Balance cannot be cashed out or transferred for any reason.

&nbsp;&nbsp;&nbsp;&nbsp; The PAW that is elevated to the PAW Stage is not guaranteed by COLLARBEAR to experience a boost in revenue.

### **Profile Rank**

&nbsp;&nbsp;&nbsp;&nbsp; Freelancers can increase their account status and reputation based on their activity and sales performance. Profile rank cannot be decreased. Every time a Freelancer completes an order, Buyer can provide ratings (in the form of stars) and testimonials for the Freelancer.The following are the COLLARBEAR Freelancer profile ranking levels:
...
&nbsp;&nbsp;&nbsp;&nbsp; There is a reward system in place on COLLARBEAR for various accomplishments made by Users, including both Freelancers and Buyers. Medals are decorative items that Users can proudly display on their profiles, and Freelancers can do the same in PAW.

### **Offer**

&nbsp;&nbsp;&nbsp;&nbsp; Buyers and Freelancers are only allowed to make Offer in the chat room provided by COLLARBEAR. Any User who engages and communicates outside of COLLARBEAR will not be covered by our Terms of Service.
...
&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR offers an optional notes function for Buyers who use Inside Worker services. Notes can be used to record anything deemed necessary by both the Buyer and the Freelancer in the form of Minutes of Meeting (MoM).
...
&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR allows Freelancers to deliver services in the form of physical objects to Buyers, but COLLARBEAR does not provide a platform for both the process of sending goods and delivery courier services.

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR takes no responsibility for the quality, quantity, security, and the form of physical products sent by the Freelancer to the Buyer.
...
&nbsp;&nbsp;&nbsp;&nbsp; By asking for our assistance in resolving disputes (in other words, appointing COLLARBEAR as arbitrator for COLLARBEAR Users), each User agrees to exert efforts to resolve the problem including opening/submitting all information on User activities before, during and after making a transaction to other Users at COLLARBEAR. User also agrees that settlement efforts will necessitate COLLARBEAR to freeze orders in progress, and COLLARBEAR reserves the ultimate right to decide solutions, including:
...
&nbsp;&nbsp;&nbsp;&nbsp; Buyers and Freelancers are only permitted to conduct transactions through COLLARBEAR's platforms and payment methods. COLLARBEAR does not provide any protection for Users who interact outside of the COLLARBEAR platform. If the transaction takes place outside of COLLARBEAR, all losses and/or damages experienced by the User are not our responsibility, and the User has no right to make any claims. For more details, please read COLLARBEAR Terms of Payment.

### **Prohibition in Information and Electronic Transactions**

&nbsp;&nbsp;&nbsp;&nbsp; You are not permitted to publish or post other people's personal or confidential information. Any personal information sharing required for the completion of a service must occur during the order process. Freelancers must also confirm that any information obtained from the Buyer that is not publicly available will not be utilized for any purpose other than working with the Buyer.COLLARBEAR only allows Buyers and Freelancers to exchange electronic files/documents. All information and file exchanges must be done exclusively on the COLLARBEAR platform. Both Buyer and Freelancer agree that if they choose to conduct electronic transactions and information outside of COLLARBEAR, all risks, including losses and/or damages sustained by the User, become their responsibility and they waive any claims against COLLARBEAR for any reason.

### **Violation**

&nbsp;&nbsp;&nbsp;&nbsp; Users may receive account warnings for violations of our Terms of Service and/or Community Guidelines, as well as user faults reported to our Committee team. Alerts will be delivered to the User's registered e-mail address and displayed on the website or mobile application for that User. Warnings will not restrict your ability to conduct actions on the account.Based on the severity of the offence, account suspension can be imposed for a certain period of time until it becomes permanent. If an account is suspended, it will be unable to do anything but communicate with the Customer Support Service.COLLARBEAR will always cooperate with the authorities in the event of investigations and investigations into certain Users who are suspected of being/are/having committed acts against the law when/by using the COLLARBEAR platform.

### **Pornography & Porn Action**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR does not permit the interchange of products and services aimed at addressing the biological needs of adults, as well as pornography and porn action.

### **Communication Ethics**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR encourages Users to pay attention to and prioritize honesty & integrity in communicating and behaving, maintaining confidentiality & security of information, and not discussing personal matters or other people's affairs within COLLARBEAR.COLLARBEAR does not tolerate & condemns the use of abusive, bullying, offensive, hate speech, and profane/inappropriate language in any form.

### **Phishing & Spam**

&nbsp;&nbsp;&nbsp;&nbsp; User safety & comfort in using COLLARBEAR is our top priority. It is completely forbidden to attempt to publish or send harmful content with the goal of causing harm to another User's account or computer environment. Please respect our Users' privacy by not approaching, forcing, or even terrorizing them with offers, inquiries, ideas, or anything else unrelated to PAW or their order.

### **Fake Identity**

&nbsp;&nbsp;&nbsp;&nbsp; You have no right to create a false identity, to willfully misrepresent your identity, to create a COLLARBEAR profile for someone other than yourself (a genuine person), or to use or attempt to use another User's account or information on COLLARBEAR.

&nbsp;&nbsp;&nbsp;&nbsp; Your profile information, including (but not limited to) personal data, location, skills, diplomas/certifications/certificates/licences, must be filled in accurately and completely, and must not be deceptive, illegal, offensive, or harmful. COLLARBEAR reserves the right to require Users to go through a legitimate verification process in order to access our services.

### **Plagiarism**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR is opposed to any form of plagiarism. Plagiarism is not authorized in the creation of PAWs or the submission of work outcomes.

### **Identity Defamation**

&nbsp;&nbsp;&nbsp;&nbsp; Users who order from a competitor's service with the intent of defaming a competitor's reputation will have their review removed or further action regarding account status will be determined by our Committee.Users are forbidden from sending spam, cajoling, or even frightening previous Buyers and/or Freelancers into deleting/modifying reviews or cancelling orders that violate the COLLARBEAR Terms of Service.

### **Account Trading**

&nbsp;&nbsp;&nbsp;&nbsp; Any COLLARBEAR account may not be traded (bought or sold) for any purpose.

### **Account Cloning**

&nbsp;&nbsp;&nbsp;&nbsp; A User may only have one active account to prevent fraud and abuse. One such account can be registered as a Buyer and Freelancer account at the same time. Any new accounts created with the intent of misappropriating, circumventing agreements/regulations, promoting competitive advantage, or misleading the COLLARBEAR community will be disabled. Bulk account creation may result in the deactivation of all associated accounts.

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR does not accept User who engage in targeted abuse or harassment of other COLLARBEAR Users. This includes acts like creating multiple new accounts to torment Users via our message and ordering systems.

### **Money Laundering**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR is not a place for User to launder money of any denomination. Therefore, you have no right and are not allowed to use COLLARBEAR as a medium or location for money laundering activities.

### **Unlawful Use**

&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR may not be used for any criminal purpose and/or to engage in any illegal conduct, either under local or international law.

# **User Generated Content (UGC)**

&nbsp;&nbsp;&nbsp;&nbsp; All content created, uploaded and distributed by Users (not by COLLARBEAR) is User Generated Content (UGC). COLLARBEAR checks the content created/uploaded by the User for copyright infringement or other rights at the time of freelancer registration and submission of PAW creation. However, due to our limits, COLLARBEAR cannot ensure that any content entered and passed inspection is 100% free of these infractions. Users who disseminate such content assume full responsibility for it and the consequences of its use, disclosure, storage, or transmission.

&nbsp;&nbsp;&nbsp;&nbsp; By uploading to – or creating content on – the COLLARBEAR platform, you represent and warrant that you own or have acquired all rights, licenses, consents, permissions, powers and/or authorities, necessary to use and/or upload such content; and during the use of such content within COLLARBEAR shall not and will not:
...
&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR®, CB® and PAW® are registered trademarks owned exclusively by BTI®. Both the site and mobile applications – including the general layout, look and feel, design, information, content and other materials available on them – are exclusively owned by COLLARBEAR and protected by copyright, trademark and other intellectual property laws.

&nbsp;&nbsp;&nbsp;&nbsp; User has no rights, and specifically agrees not to do any of the following with respect to the mobile site & application or any part, component or extension of the COLLARBEAR mobile site & application:
...
4) Use automation software (bots), hacks, modifications (mods), or other unofficial third-party software designed to modify COLLARBEAR;

5) Attempt to gain unauthorized access to, interfere with, damage, or disrupt the mobile site & application or any computer system or network connected to COLLARBEAR;

6) Circumvent, remove, modify, disable, degrade or thwart any technological or content protection measures from COLLARBEAR;

7) Use any robot, spider, crawler or other automated tool, process, software or query that intercepts, mines, scrapes or accesses COLLARBEAR to monitor, extract, copy or collect information or data from/or through COLLARBEAR, or engage in any manual process to do the same;
...
9) Using COLLARBEAR in any way that can damage, disable, overburden or damage COLLARBEAR, or interfere with the comfort of other Users at COLLARBEAR; and

10) Access or use COLLARBEAR in any way that is not expressly permitted by these Terms of Service. Users also agree not to allow or authorize other people to do the things above.

&nbsp;&nbsp;&nbsp;&nbsp; Except for the limited right to use the mobile site and application under these Terms of Service, COLLARBEAR owns all right, title, and interest in and to the mobile site and application (including any and all intellectual property rights therein), and you agree not to take any action that contradicts the ownership interest. We reserve all rights in the mobile site and application and its content (other than UGC), including the exclusive right to produce derivative works.
...
&nbsp;&nbsp;&nbsp;&nbsp; Furthermore, the User (both Buyer and Freelancer) agrees that, unless they explicitly state otherwise, the content that the User voluntarily creates/uploads to COLLARBEAR, including text, photos, PAW videos; username, user photo, user video, and other information; and displays of submitted work, may be used by COLLARBEAR for marketing and/or other purposes without remuneration.
...
&nbsp;&nbsp;&nbsp;&nbsp; COLLARBEAR is also not liable for the User's (both Buyers and Freelancers) behavior, ethics, morality, and morals, and the User agrees to renounce all claims for risks and/or losses deriving from these matters.
