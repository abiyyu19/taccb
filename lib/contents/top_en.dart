...
&nbsp;&nbsp;&nbsp;&nbsp; Before making or receiving payments through Klikjob, Users should carefully read and understand these Terms of Payment. By making or receiving payments through Klikjob, you accept and agree to be bound by and comply with this Agreement on your own behalf or behalf of your employer or other entity (as applicable). This Agreement is in addition to Klikjob’s Terms of Service.

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob may amend these Terms of Payment at any moment. You understand and agree that if you use Klikjob after the Terms of Payment have been amended, Klikjob will regard your use as an agreement to the changes/updates to these Klikjob’s Terms of Payment.

# **Definition/Terminology**

### **Admin Fee**

&nbsp;&nbsp;&nbsp;&nbsp; Fees charged by Klikjob's Payment Service Provider(s) for each balance withdrawal transaction made by the User.
...
&nbsp;&nbsp;&nbsp;&nbsp; Klikjob's official non-cash wallet – also known as CB Balance – is utilized as a payment option. CB Balance also functions as a combined amount of the User’s revenue (as a Freelancer) and/or funds returned from cancelled orders (as a Buyer).

### **Payment Service Provider (PSP)**

&nbsp;&nbsp;&nbsp;&nbsp; Service providers that offer payment services to Buyers and Freelancers related to the Klikjob platform, such as collecting funds from Buyers for purchases, sending money, and withdrawing funds to Freelancers, currency exchange services for payments and withdrawals in local currency, and CB Balance depository.

### **Platform Fee**

&nbsp;&nbsp;&nbsp;&nbsp; Fees charged by Klikjob for each transaction made by the User.
...
&nbsp;&nbsp;&nbsp;&nbsp; Funds that Freelancers get from completed orders/projects and can be withdrawn or used to shop at Klikjob—are bound and subject to these Payment Terms & Conditions.

### **Withdrawal**

&nbsp;&nbsp;&nbsp;&nbsp; The procedure of transferring funds from Klikjob to the User's preferred account—is bound and subject to these Payment Terms & Conditions.

# **Purchase**

### **General**

&nbsp;&nbsp;&nbsp;&nbsp; Using the "Accept & Pay" button, Buyers pay Klikjob to place orders from Freelancer’s PAW page or custom Offer. The aim of Klikjob in collaborating with PSP is to collect all payments from Buyers, transfer those payments to eligible Freelancers, and hold funds in respect of the CB Balance. All payment services in connection with fundraising on the Klikjob platform are performed by Klikjob’s PSP.

&nbsp;&nbsp;&nbsp;&nbsp; Appointment as Limited Payment Collection Agency: The Freelancer hereby appoints Klikjob as its limited authorized payment collection agent solely to obtain payment from the Buyer (through PSP, if using its services) and then deliver the payment to the Freelancer. Buyer's payment obligations to Freelancers will be met once Klikjob (or PSP, as applicable) receives payment, and Klikjob (through PSP, as applicable) is responsible for delivering payments to Freelancers in the manner indicated in these Terms of Payment. If Klikjob (through PSP) does not pay the requested funds to the Freelancer, the Freelancer will only seek assistance from Klikjob and not from the Buyer directly.
...
&nbsp;&nbsp;&nbsp;&nbsp; Buyer may not offer Freelancer to accept payment using any method other than those provided by Klikjob. If you are asked to accept a different payment method, please report it to Klikjob’s Customer Support Service immediately.

&nbsp;&nbsp;&nbsp;&nbsp; Freelancer may not offer Buyer to make payments using any method other than those provided by Klikjob. If you are asked to use a different payment method, please report it to Klikjob’s Customer Support Service immediately.

&nbsp;&nbsp;&nbsp;&nbsp; You agree to receive bills and/or payment receipts from Klikjob electronically in the form of PDF documents by email, website, or mobile application.

To avoid fraud, unlawful transactions (such as money laundering), claims, or other liabilities, payment information related to the withdrawal will be billed by Klikjob or Klikjob's PSP. PSP may also collect additional information required to execute payment (balances) withdrawals. Klikjob has no access to payment information submitted to PSP, and this information is subject to PSP's privacy policies. For additional information, please see and read our Privacy Policy.

&nbsp;&nbsp;&nbsp;&nbsp; You represent and warrant that, by using any payment method and/or giving payment details (to process) to make purchases at Klikjob, you:
...
3. If you are an employee or agent of a company or person who has (access to) a (such) payment method, you have been authorized by the company or person to use the relevant payment method to make payments at Klikjob; and

4. The action does not violate applicable laws.

### **Coupon**

&nbsp;&nbsp;&nbsp;&nbsp; We may – from time to time – offer coupons containing promo codes for both PAW purchases and/or other sorts of Klikjob transactions, in the form of discount/cashback with certain conditions. Coupons are only applicable for purchases at Klikjob, have time limits, and may expire after a certain amount of time. The cashback will be reimbursed to your CB Balance.

&nbsp;&nbsp;&nbsp;&nbsp; Coupons are limited to one use per User and may not be used or combined with other coupons/promotions. Coupons may be subject to additional terms and restrictions as will be disclosed to you upon receipt of the coupon. In the event of fraud, abuse, or a violation of the Terms of Service, the promotional code may be revoked. Klikjob reserves the right to amend or cancel the promo code at any moment, with or without prior notice to the User.
...
&nbsp;&nbsp;&nbsp;&nbsp; Appointment as Limited Payment Collection Agency: Freelancer hereby appoints Klikjob as its limited authorized payment collection agent solely to obtain payment from Buyer (through PSP, if using its services) and then deliver the payment to Freelancer. Freelancer agrees that payments received from Buyers to Klikjob will be considered the same as payments made directly to Freelancers. Buyer's payment obligations to Seller will be met once payment is received by Klikjob (or PSP, as applicable), and Klikjob is responsible for delivering payments to Freelancer in the manner outlined in these Payment Terms & Conditions. If Klikjob (through PSP) does not pay the requested funds to the Freelancer, the Freelancer will only seek assistance from Klikjob and not the Buyer directly. Klikjob commits to explain or reflect the conditions included in this document in any terms of service, receipt, disclosure, or notification, including (but not limited to) receipts issued to Buyer that Klikjob deems essential or important.

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob collaborates with PSP to collect payments from Buyers, deliver those payments to Freelancers, and hold the associated funds in the form of a CB Balance. Klikjob PSP handles all payment processes linked to withdrawing funds from the Klikjob platform.
...
&nbsp;&nbsp;&nbsp;&nbsp; To withdraw your account balance, you must have an account linked to at least one of the PSPs supported by Klikjob for the withdrawal methods indicated in the "Withdrawal Methods" section. Klikjob PSP will provide all payment services, including withdrawal services.
...
&nbsp;&nbsp;&nbsp;&nbsp; Freelancers can withdraw their earnings using one of Klikjob's withdrawal methods (for withdrawal limitations, see the "Withdrawal Methods" section). To begin the withdrawal process for your available profits, click on the chosen withdrawal provider.
...
&nbsp;&nbsp;&nbsp;&nbsp; For the time being, CB Balance only recognizes IDR currency, thus Users can only withdraw their balance in IDR. Klikjob, on the other hand, does not rule out giving support for several different currencies, where market needs and wants, as well as input from our community, will be one of two determining considerations.

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob may temporarily block the User's ability to withdraw balances to prevent fraudulent or illicit activity. This can happen if a security problem occurs, another User reports a proven violation or the system detects a violation.
...
&nbsp;&nbsp;&nbsp;&nbsp;  Klikjob delivers funds to Users via the RTOL mechanism.
...
&nbsp;&nbsp;&nbsp;&nbsp; Order cancellations are permitted at Klikjob – if eligible – via the Order Details page per order and/or through Klikjob's Customer Support Service.
...
&nbsp;&nbsp;&nbsp;&nbsp; If you encounter a problem with the services provided by our Freelancers, you are advised to use Klikjob's dispute resolution service to try to address the matter.

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob, through PSP, reserves the right to cancel orders or withhold funds for alleged fraudulent transactions made within the platform.
...
&nbsp;&nbsp;&nbsp;&nbsp; Klikjob encourages Buyers and Freelancers to address disputes between themselves through the Help Center.

&nbsp;&nbsp;&nbsp;&nbsp; Our Customer Support Services team will evaluate the feasibility of a request for Klikjob to cancel an order based on a number of reasons, including violations of our Terms of Service and/or Community Guidelines, common errors, and improper use of Klikjob's work/deliverables submission system.
...
&nbsp;&nbsp;&nbsp;&nbsp; Before contacting the Customer Support Service, you must first use the Klikjob Help Center to solve your problem and obtain the required resolution relating to the services provided/delivered by the relevant Freelancer. If the concerned person fails to notify the relevant Freelancer of the problem linked to the Freelancer's service, the Customer Support Service will not take any action on the order and will allow the Freelancer to provide independent solutions first. Actions like this are not something that is not allowed in Klikjob.

&nbsp;&nbsp;&nbsp;&nbsp; Any unlawful use of Klikjob discovered during the order process may result in order cancellation after being reviewed by our Customer Support Service team. This includes—but is not limited to; harassment, unlawful conduct, illegal behaviour, or any other violation of the Klikjob Terms of Service.

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob’s Customer Support Service will cancel orders for the following grounds, but not limited to:
...
1. Active orders (after the requirements/needs are submitted to the Freelancer and before the Freelancer delivers the work):
    ...
    d. Users are no longer an active user of Klikjob due to violation of Terms of Service or deactivation of their account.
...
2. Orders sent (after Freelancer uploads the finale project deliverables file [Inside Worker] or doing a clock out [Field Worker] and before the order is marked as “Done”):
    ...
    c. Freelancers request additional payments both within and outside the Klikjob platform by withholding the final work/delivery of services directly relevant to the agreed terms/needs.
...
&nbsp;&nbsp;&nbsp;&nbsp; Klikjob reviews chargeback cases and payment provider disputes on behalf of Freelancer. While the outcome may vary case by case for each (different) chargeback reason, we strive hard to resolve disputes in the best interests of Freelancers. If the chargeback case allows, Klikjob (or one of Klikjob's PSPs) will reimburse some or all of the earnings to the Freelancer – otherwise – the chargeback sum will be borne by the Freelancer.

### **Refund**

&nbsp;&nbsp;&nbsp;&nbsp; Klikjob does not automatically refund payments made for cancelled orders to your payment provider. Funds from order cancellations are returned in the form of CB Balance or Refund Balance and are available to be spent again at Klikjob.
...
1. Cancellation with CB Balance payment method:
    ...
    b. The funds can be withdrawn using the withdrawal method provided by Klikjob.
...
&nbsp;&nbsp;&nbsp;&nbsp; Buyers are allowed to cancel the auction they open at any time, but Klikjob stipulates the following terms to avoid misunderstandings between the Buyer and the Freelancer when the Buyer modifies the details of the auction after the Freelancer has placed a bid.
...
&nbsp;&nbsp;&nbsp;&nbsp; Klikjob is also not liable for the User's (both Buyers and Freelancers) behaviour, ethics, morality, and morals, and the User agrees to renounce all claims for risks and/or losses deriving from these matters.
